...
from .db.models import program, question_activity, question_option, section, text_activity
...
async def init_db():
    ...
    for entity in program_entities:
        for i in range(PROGRAM_TO_SECTIONS[entity.name]):
            ...
            for j in range(random.randint(5, 10)):
                if j % 2 == 0:
                    ...
                    question_option.QuestionOption.seed(question_activity_entity)
                else:
